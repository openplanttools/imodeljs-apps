...
// import { TreeNodeItem,
//  // Tree,
//   TreeProps } from "@bentley/ui-components";
...
//   public theData: PresentationTreeDataProvider;
...
//         <div>
//           <span></span>
//           <div><SimpleTree dataProvider = {this.theData} reloadCheck={this.state.imodel} theNodes={this.theNodes} isLoading={this.state.isLoading} /></div>
//         </div>);
//     }
//   }
// }
...
// export class FilteredTreeComponent extends React.PureComponent<CustomTreeProps, TreeState> {
...
// export const SimpleTree = treeWithUnifiedSelection(FilteredTreeComponent);
