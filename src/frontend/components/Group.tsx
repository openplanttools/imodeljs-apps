...
/* IProjetcList class ,is a react component, has an app state with defined instance variables to keep track of relevant information */
    ...
    return (
      <form onSubmit={() => this.handleSubmit}>
        <label className="label">
          <select id="dropList" name="ProjectList" style={{ fontFamily: "sans-serif" }} value="List of Projects" onChange={() => { this.handleSubmit() }}>{iModelDataWidget().map((iModelItem) => {
